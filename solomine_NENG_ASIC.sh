...
# base diff <  1
/home/user/FutureBit/bfgminer_5.4.2-futurebit2_linux_x86_64/bfgminer --scrypt --url=127.0.0.1:8376  -u  wallet2user   -p wallet2passwd  --url=127.0.0.1:8378 -u wallet5user -p  wallet5passwd  --retries  -1  --rotate 1 --no-stratum  --net-delay -S /dev/ttyUSB0 --set MLD:clock=384
